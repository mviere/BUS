    ...
    while not endProgram:
        ...
        for index, cols in df_escenario.iterrows():
            ...
            if event:
                ...
                command_queue, df_nominalvalues = mode_management(df_mode, deftable_modos, deftable_transicion, deftable_housekeeping, ciclos, dT)
                mode_management (mode_name, cant_ciclos, dT, deftable_modos, deftable_transicion, deftable_housekeeping)
